...
$header .= "From: Новая заявка <lesnovartem7@gmail.com>\n\n";	
$mail = mail("lesnovartem7@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
